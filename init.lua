...
-- Keybidings Maintain cursor position when yeanking a visual selection
vim.keymap.set('v', 'y', 'myy`y', { desc = 'Maintain cursor position when yeanking in visual selection' })
vim.keymap.set('v', 'Y', 'myY`y', { desc = 'Maintain cursor position when yeanking in visual selection' })

-- Keybinds to insert sing at the end of line
vim.keymap.set('n', ';;', '<Esc>A;<Esc>', { desc = 'Insert a ; at the end of a line' })
vim.keymap.set('n', ',,', '<Esc>A,<Esc>', { desc = 'Insert a , at the end of a line' })
vim.keymap.set('n', '::', '<Esc>A:<Esc>', { desc = 'Insert a : at the end of a line' })
